...
COMMON_SOUL_TEMPLATE = (
    ...
    "for, the brand, the goals, and shared conventions. It is FILLED IN, not a "
    "blank template. READ IT ONCE at the start of your first task so you share the "
    "team's context; you do not need to re-read it every task.\n"
